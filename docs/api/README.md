...
| 知识管理 | 上传、检索和管理知识内容 | [knowledge.md](./knowledge.md) · [API 上传对接手册（方案 A）](../feature/2026-07-14-知识文档API上传对接手册.md) |
| 工作空间知识目录 | 空间 Key 拉自有 ∪ 组织分享库目录，再按库游标扫知识、按需下载源文件 | [2026-09-01-工作空间授权知识目录拉取.md](./2026-09-01-工作空间授权知识目录拉取.md) · [实测样例](./2026-09-01-工作空间授权知识目录拉取-实测样例.md) |
...
| 开放检索 | 无登录态知识分片检索 | [open-knowledge-retrieve.md](./open-knowledge-retrieve.md) |
