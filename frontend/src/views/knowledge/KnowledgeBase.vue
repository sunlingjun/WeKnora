...
import { useUploadConfirmStore, type UploadConfirmResult, type UrlImportItem } from '@/stores/uploadConfirm';
...
const openUploadConfirmDialog = async (files: File[], urls: UrlImportItem[] = []) => {
...
const handleUploadSourceUrl = (item: UrlImportItem) => {
  if (!ensureDocumentKbReady()) return;
