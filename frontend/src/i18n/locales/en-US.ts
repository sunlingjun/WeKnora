...
\
  ...
  integrations: {
    ...
    api: {
      ...
      mcpRetrieveUrlDesc: 'Remote Streamable HTTP MCP for knowledge retrieve / wiki graph. Use an API key with the retrieve capability; copy MCP config from the key row.',
