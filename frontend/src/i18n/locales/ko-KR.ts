export default {
      ...
      keyDescriptions: {
        ...
        tenant: {
          ...
          default_storage_quota_gb:
            "신규 워크스페이스 생성 시 기본으로 할당되는 저장 용량(GB)으로, 벡터·원본·텍스트·인덱스 등을 포함합니다. 생성 시에만 읽으며, 변경은 이후 생성되는 워크스페이스에만 적용되고 기존 워크스페이스에는 소급되지 않습니다. 0 또는 음수는 내장 기본값 1GB를 사용합니다.",
          auto_create_api_key:
  ...
  knowledgeList: {
    ...
    messages: {
      ...
      joinedFailed: "참여 실패",
      fetchMembersFailed: "멤버 목록을 불러오지 못했습니다",
      roleUpdated: "멤버 역할이 업데이트되었습니다",
      roleUpdateFailed: "멤버 역할 업데이트에 실패했습니다",
      memberRemoved: "멤버가 제거되었습니다",
      memberRemoveFailed: "멤버 제거에 실패했습니다",
    },
    members: {
      title: "멤버 관리",
      description: "지식베이스 \"{name}\"의 멤버를 관리합니다",
      searchPlaceholder: "이메일 또는 이름으로 검색",
      empty: "멤버가 없습니다",
      unknownUser: "알 수 없는 사용자",
      joinedAt: "가입 시간",
      confirmRemoveTitle: "멤버 제거",
      confirmRemoveMessage: "멤버 \"{name}\"을(를) 제거하시겠습니까?",
      actions: {
        setEditor: "편집자로 설정",
        setViewer: "열람자로 설정",
        remove: "멤버 제거",
