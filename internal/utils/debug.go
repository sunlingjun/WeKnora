...
func CleanupStaleRunningTasks(ctx context.Context, redisClient redis.UniversalClient, keyPrefix string, maxAge time.Duration) (int, error) {
	// 获取所有匹配的keys
...
func CheckRunningTaskStatus(ctx context.Context, redisClient redis.UniversalClient, runningKey, progressKey string) (map[string]interface{}, error) {
