...
func TestKnowledgeReadRoutesDeclareRetrieveCapability(t *testing.T) {
	...
	RegisterKnowledgeMCPRoutes(v1, func(c *gin.Context) {}, g)
	...
	cases := []struct {
		...
		{http.MethodGet, "/api/v1/mcp/retrieve"},
		{http.MethodPost, "/api/v1/mcp/retrieve"},
		{http.MethodDelete, "/api/v1/mcp/retrieve"},
	}
...
func TestTenantMemberRoutesDeclareManageMembersCapability(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodPost, "/api/v1/tenants/:id/members/cas-import/preview"},
		{http.MethodPost, "/api/v1/tenants/:id/members/cas-import"},
